...
##### cpu.py: Main instructions and architecture
##### ls8.py: script to run our virtual computer
##### examples/**: collection of ls8 scripts for our computer to execute, machine code
